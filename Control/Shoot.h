...
#define OFF_MASK  0
#define Shot_SP_1			(36.57 *8 /3.6f)									// Shot_SP_1：单发拨盘补偿系数（需实测）
#define BOPAN_ANGLE         (8192 * 10.0f)									//����(8192 * 36.0 / 8.0f)
#define BP_TEST_FLAG 0
#define BP_ERROR_ONE   bp->One_Target_Angle -= BOPAN_ANGLE  * 0.5F
#define BP_ERROR_CON   bp->Continuous_Target_Angle -= 0.6F*BOPAN_ANGLE
#define BP_RECOVERY_MIN_INTERVAL_MS 500
